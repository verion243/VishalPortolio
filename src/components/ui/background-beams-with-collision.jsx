...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-96 md:h-screen bg-gradient-to-b from-white to-neutral-100 dark:from-black dark:to-neutral-950 relative flex items-center w-full justify-center overflow-hidden",
